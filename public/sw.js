const CACHE_NAME = 'warm-pomodoro-v1.2';
const ASSETS = [
  '/',
  '/index.html',
  '/manifest.json',
...
// Cache first strategy with network fallback for assets, or network first for api/dynamic things
